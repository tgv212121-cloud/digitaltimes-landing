export const landingContent = {
  hero: {
    ...
    workflow: [
      ...
      {
        title: "Workflow n8n + IA qui supprime les frictions du quotidien",
        description:
          "Qualification, routing, enrichissement, reporting, onboarding, relances et circulation d'information entre vos outils.",
        tag: "Automation",
      },
      {
  ...
  services: {
    ...
    cards: [
      ...
      {
        kicker: "02",
        title: "Automatisations n8n et IA",
        description:
          "Je branche votre stack pour automatiser ce qui ralentit la vente, le delivery et le suivi client.",
        bullets: [
  ...
  timeline: {
    ...
    title: "Je vais vite, mais je ne vends pas du flou.",
    steps: [
      {
        phase: "Jours 1-2",
        title: "Cadrage utile",
