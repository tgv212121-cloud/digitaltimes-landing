...
export function ContactForm() {
  ...
  const inputClass =
    "w-full border border-white/15 bg-black/40 px-4 py-3 text-[14px] text-ivory placeholder:text-ivory/30 focus:border-saffron focus:outline-none transition-colors";
  const labelClass =
