    ...
    <main className="relative min-h-screen overflow-x-hidden bg-ivory text-graphite">
            ...
            <Reveal delay={0.08}>
              <div className="bg-[#0e0c0a] p-6 text-ivory sm:p-8">
                ...
                <div className="mt-8 grid gap-0">
                  ...
                  <div className="flex items-start gap-3 py-4">
                    <span className="mt-0.5 text-[16px] text-emerald-400">✓</span>
                    <p className="text-[15px] font-semibold leading-[1.8] text-ivory/85">À partir de 400 € + 50 €/mois. Transparent dès le brief.</p>
                  </div>
                </div>
              </div>
            </Reveal>
      ...
      <section id="contact" className="bg-[#0e0c0a] py-20 text-ivory sm:py-24">
        <div className="section-shell">
          ...
          {/* 2 columns : Form left, Booking iframe right */}
            ...
            <Reveal delay={0.1}>
              <div className="flex h-full flex-col">
                <div className="mb-6">
                  ...
                  <h3 className="display-font mt-3 text-[clamp(1.6rem,3vw,2.2rem)] font-[400] italic leading-[1] tracking-[-0.03em] text-ivory">
                ...
                <div className="flex-1" style={{ background: "#D4A574" }}>
                  <iframe
                    src="https://app.digitaltimes.fr/book/site?embed=1"
                    title="Prendre rendez-vous avec Thomas Gildas"
                    loading="lazy"
                    className="block h-[1400px] w-full border-0 lg:h-[900px]"
